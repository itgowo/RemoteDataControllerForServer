        ...
        if (result.code == 200) {
          ...
          for (i = 0; i < FilecolumnData.length; i++) {
            ...
            if (FilecolumnData[i].dir == true) {
              FilecolumnData[i].fileName = "<div onClick='getFileList(\"" + FilecolumnData[i].path + "\")'> <img src=\"web/images/folder.png\"/> <a>" + FilecolumnData[i].fileName + "</a></div>";
              FilecolumnData[i].delete = "";
            } else {
              FilecolumnData[i].fileName = "<div  onClick='downloadFile(\"" + FilecolumnData[i].path + "\")'> <img src=\"web/images/file.png\"/><a>" + FilecolumnData[i].fileName + "</a></div>";
